...
namespace ProgramSymulacyjny1
{
    public partial class Form1 : Form
    {
        ...
        void ReadProcesses() // wczytuje dane z pliku wsadowego ProcessList1.txt (format: nr_procesu czas_przyjscia czas_wykonywania)
        {
        ...
        void FCFSZ()  // zamknięta pula procesów
        {
        ...
        void FCFSO()  // otwarta pula procesów
        {
            bool decision = true;
            List<Process> result = processList.OrderBy(x => x.ArrivalTime).ToList();
        ...
        void SJFZ() // zamknięta pula procesów
         {
        ...
        void SJFO() // otwarta pula procesów
        {
            List<Process> processList1 = new List<Process>();
            List<Process> result = new List<Process>();
            Process p1 = new Process();
        ...
        void CalculateAverage(List<Process> result, int time , string str) // Liczy statystyki - średnie czasy przetwarzania i oczekiwania
        {
        ...
        void ClearChart(System.Windows.Forms.DataVisualization.Charting.Chart chart ) // czyści pola wykresu
        {
